...
from src import habit
from src import choice
from src import option
from src import choose
from src import ladybug
...
def habit1():
  ...
  while movement:
    ...
    game_font_1 = pygame.font.SysFont("bar", 25)
    ...
    game_font_10 = pygame.font.Font(None, 35)
    text_10 = game_font_10.render("Yes",True,text_color)
    ...
    if pygame.mouse.get_pressed()[0] ==0:
           ...
           if pygame.mouse.get_pressed()[0]==1 and yes1.clicked == False:
              ...
              loading = game_font_1.render("Loading: "  + str(int(progress)) + "%", True, green)
              
              pygame.draw.rect(screen, green, (0,300, progress, 100))
              screen.blit(loading, (453, 273))
    ...
    if pygame.mouse.get_pressed()[0] ==0:
           ...
           if pygame.mouse.get_pressed()[0]==1 and no1.clicked == False:
              ...
              text = game_font_1.render("Loading: "  + str(int(progress)) + "%", True, green)
    ...
    for event in pygame.event.get():
            if event.type ==pygame.QUIT:
                with open('progress_bar.txt','w') as progress_file:
